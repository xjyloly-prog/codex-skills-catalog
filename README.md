...
1. [竞赛策划与申报 / Competition proposals](#1-竞赛策划与申报) — 15 个
2. [演示与路演 / Presentations](#2-演示与路演) — 5 个
3. [数学建模 / Mathematical modeling](#3-数学建模) — 48 个
4. [三维建模 / 3D modeling (Blender)](#4-三维建模) — 60 个
5. [图表与可视化 / Charts & diagrams](#5-图表与可视化) — 3 个
6. [网页与设计原型 / Web & design prototypes](#6-网页与设计原型) — 122 个
7. [文档与办公 / Documents & office](#7-文档与办公) — 10 个
